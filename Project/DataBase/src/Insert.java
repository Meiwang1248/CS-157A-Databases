...
public class Insert
{
    ...
    public void fillTable()
    {
        try
        {
            // Storing random generated words in an array to populate in the
            // tables
            ...
            String sequence = "Create sequence " + seq
                    + " start with 1 increment by 1 minvalue 1 maxvalue 1000;";
            String seq2 = "publisherId";
            String sequence2 = "Create sequence " + seq2
                    + " start with 1 increment by 1 mivalue 1 nomaxvalue;";
            try
            {
                for (int i = 1; i < 19; i++)
                {
                    ...
                    String title = "INSERT INTO TITLES(ISBN, TITLE, EDITIONNUMBER, YEAR, PUBLISHERID, PRICE) VALUES ('ISBN"
                            + i + " ' ,' " + titles[i] + " ' , " + (100 + i)
                            + " , " + (1997 + i) + " , " + i + " , " + (10 + i)
                            + ") ";
